...
<head>
    ...
    <style>
        ...
        /* Style untuk pesan notifikasi hasil transaksi */
        #message-box {
            display: none;
            padding: 1.5rem;
        ...
        /* Style untuk Notifikasi Real-time (Toast) */
        ...
        .toast {
            ...
            animation: slideIn 0.3s ease-out, fadeOut 0.5s 7s forwards;
            position: relative;
            overflow: hidden;
        }
        .toast-title {
...
<body class="antialiased">
    ...
    <!-- Container Notifikasi Real-time -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6 lg:sticky lg:top-24">
                ...
                <div class="bg-slate-800 rounded-lg shadow-xl p-6">
                    ...
                    <!-- Kotak Khusus Info DANA -->
                    <div id="dana-info" class="mt-6 p-4 bg-blue-900/50 rounded-lg border border-blue-600 text-center">
                        <h3 class="text-base font-bold text-white mb-2">Transfer DANA (Transfer Bank atau QRIS)</h3>
                        <p class="text-sm text-blue-200 mb-3">
                            Setelah klik 'Beli Sekarang', Anda dapat membayar dengan **QRIS (Scan & Bayar)** atau **Transfer Bank** ke akun DANA kami:
                        </p>
                        ...
                        <p class="text-xs text-blue-300 mt-3">
                            **PENTING:** Detail QRIS/Nomor tujuan DANA akan muncul di notifikasi setelah klik 'Beli Sekarang'.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-slate-800 rounded-lg shadow-xl p-6">
                    ...
                    <div class="space-y-2 text-sm text-slate-300 mb-4">
                        <!-- RINGKASAN BARU: ID Pengguna & Nama Akun -->
                        <div class="flex justify-between border-b border-slate-700 pb-2">
                            <span>ID Pengguna:</span>
                            <span id="summary-user-id" class="font-medium text-white">-</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Nama Akun:</span>
                            <span id="summary-account-name" class="font-bold text-yellow-300">-</span>
                        </div>
                        <!-- Akhir Ringkasan Baru -->
                        ...
                        <div id="summary-admin-fee-row" class="flex justify-between border-t border-slate-700 pt-2 hidden">
                            <span class="text-xs text-slate-400">Biaya Admin:</span>
                            <span id="summary-admin-fee" class="font-medium text-xs text-slate-400">Rp 0</span>
                        </div>
                    ...
                    <!-- Kotak Input Email dipindahkan ke atas tombol Beli -->
                    <div class="mt-4">
                    ...
                    <!-- Kotak Pesan Notifikasi Hasil Transaksi -->
    ...
    <script type="module">
        ...
        // Global Firebase and App variables (Mandatory for Canvas Environment)
        ...
        const diamondPackages = [
            ...
            { id: 'd222', name: '222 Diamonds', price: 61031, price_text: '
